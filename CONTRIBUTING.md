# Contributing to DependencyManager.FsProj
...
your Operating System, as well as your `dotnet` (or `mono` \ .Net Framework), F# and DependencyManager.FsProj versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/DependencyManager.FsProj
   # Navigate to the newly cloned directory
   cd DependencyManager.FsProj
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Krzysztof-Cieslak/DependencyManager.FsProj
   ```
